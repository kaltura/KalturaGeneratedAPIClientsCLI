...
sed  -e "s#www.kaltura.com#$API_HOST#g" -e "s#~/kaltura/log#$PREFIX/log#g" -e "s#867352#$PARTNER_ID#g" -e "s#e842756d94dacf813e04db720fee9119#$ADMIN_SECRET#g" $PREFIX/config/config.template.ini > $PREFIX/config/config.ini
